...
public class registration_activity extends Activity
{
     ...
     */
    public loading_callback<BackendlessUser> createRegistrationCallback()
    {
        return new loading_callback<BackendlessUser>( this, getString( R.string.loading_register ) )
        {
            @Override
    ...
    public View.OnClickListener createRegisterButtonClickListener()
    {
        return new View.OnClickListener()
        {
            ...
            public void onClick( View v )
            {
                ...
                {
                    loading_callback<BackendlessUser> registrationCallback = createRegistrationCallback();

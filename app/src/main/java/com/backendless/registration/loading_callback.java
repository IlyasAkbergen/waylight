 ...
 */
public class loading_callback<T> implements AsyncCallback<T>
{
     ...
     */
    public loading_callback( Context context )
    {
    ...
    {
        progressDialog.dismiss();
        dialog_helper.createErrorDialog( context, "BackendlessFault", fault.getMessage() ).show();
    }
